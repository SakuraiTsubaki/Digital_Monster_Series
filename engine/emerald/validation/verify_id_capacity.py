...
def main() -> None:
    ...
    techniques = ids(GEN / "technique-id-map.csv", "emerald_move_id")
    ...
    assert max(techniques) <= TECHNIQUE_MAX
    ...
    print(f"  techniques : {len(techniques)} / {TECHNIQUE_MAX} (12-bit target)")
